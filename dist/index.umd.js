(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@babel/runtime/helpers/classCallCheck'), require('@babel/runtime/helpers/createClass'), require('@babel/runtime/helpers/inherits'), require('@babel/runtime/helpers/possibleConstructorReturn'), require('@babel/runtime/helpers/getPrototypeOf'), require('react'), require('react-draggable'), require('react-bootstrap'), require('react-redux')) :
    typeof define === 'function' && define.amd ? define(['@babel/runtime/helpers/classCallCheck', '@babel/runtime/helpers/createClass', '@babel/runtime/helpers/inherits', '@babel/runtime/helpers/possibleConstructorReturn', '@babel/runtime/helpers/getPrototypeOf', 'react', 'react-draggable', 'react-bootstrap', 'react-redux'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global['zg-progressbar-library'] = factory(global._classCallCheck, global._createClass, global._inherits, global._possibleConstructorReturn, global._getPrototypeOf, global.React, global.Draggable, global.reactBootstrap, global.reactRedux));
}(this, (function (_classCallCheck, _createClass, _inherits, _possibleConstructorReturn, _getPrototypeOf, React, Draggable, reactBootstrap, reactRedux) { 'use strict';
    ...
    var ZgProgressSlider = /*#__PURE__*/function (_Component) {
      _inherits__default['default'](ZgProgressSlider, _Component);
      ...
      function ZgProgressSlider(props) {
        ...
        _classCallCheck__default['default'](this, ZgProgressSlider);

        _this = _super.call(this, props);
        _this.progressBarRef = /*#__PURE__*/React__default['default'].createRef();
      ...
      _createClass__default['default'](ZgProgressSlider, [{
        key: "calcPos",
        ...
        value: function render() {
          ...
          var swapIcon = !isDisabled ? /*#__PURE__*/React__default['default'].createElement("div", {
            ...
            }, /*#__PURE__*/React__default['default'].createElement("div", null, blockerText))
          ...
          }, percentage === 100 ? /*#__PURE__*/React__default['default'].createElement("img", {
          ...
          }, percentage, "%"), swapIcon, /*#__PURE__*/React__default['default'].createElement("div", {
    ...
    var ZgProgressSlider$1 = reactRedux.connect(mapStateToProps, mapDispatchToProps)(ZgProgressSlider); // export default ZgProgressSlider;

    var controls = function controls() {
      return {
        ZgProgressSlider: ZgProgressSlider$1 // We can add here multiple components in the future
